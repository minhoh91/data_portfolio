...
1: The "Incentive Impact" Conversion Audit: Evaluated a "Signup Incentive" experiment by joining experimental cohorts with transaction data; utilized SQL 
CTEs and Left Joins to calculate the Activation Rate (conversion from signup to first deposit) for Control and Test groups, identifying the statistical lift generated by the incentive.
